...
class AboutScreen:
    ...
    def __init__(self, win, frameRate, version):
        ...
        self.aboutText_1 = TextBox("ReBel version {}.".format(self.version[1:]),
                                   (self.x+20, self.aboutTitleText.y+self.aboutTitleText.h+7), width=self.width-40, font='tiny')
        self.aboutText_2 = TextBox("ReBel is a client-server-based multiuser online ringing software. Developed by Samuel M. Senior and " + \
                                   "open-sourced using the BSD-3-Clause license. Source code can be downloaded from " + \
                                   "'https://github.com/samuelsenior/ReBel' and the latest release can be downloaded from " + \
                                   "'https://github.com/samuelsenior/ReBel/releases'.",
                                   (self.x+20, self.aboutText_1.y+self.aboutText_1.h+10), width=self.width-40, font='tiny')
        self.aboutText = [self.aboutTitleText, self.aboutText_1, self.aboutText_2]
